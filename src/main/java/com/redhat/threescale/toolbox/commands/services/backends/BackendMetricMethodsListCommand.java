...
public class BackendMetricMethodsListCommand implements Runnable {

    private static final Logger LOG = Logger.getLogger(BackendMetricMethodsListCommand.class);
    ...
    public void run() {
        try {
            String response = accountManagementServiceFactory.getAccountManagementService().getBackendMetricMethods(backendId, metricId);
